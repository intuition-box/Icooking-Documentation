...
const config: Config = {
  ...
  url: 'https://doc-icooking.intuition.box',
  ...
  projectName: 'Icooking-Documentation', // Usually your repo name.
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https://github.com/intuition-box/Icooking-Documentation',
          label: 'GitHub',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      copyright: `Copyright © ${new Date().getFullYear()} ICooking Documentation, Inc. Built with Docusaurus.`,
    },
    prism: {
